...
const WalletMenu: React.FC<DropdownProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={dropdownRef}
        className="dropDown-hidden pixel-art-border-xs-dark text-black absolute bg-gradient-to-r from-cadet-blue-light to-cadet-blue-dark flex flex-col justify-center items-center shadow-lg w-full"
      >
