...
const EarnPointsIcon: FC<IconProps> = ({
  width = 64,
  height = 64,
  ...props
}) => {
  return (
    ...
    >
      <g clip-path="url(#clip0_45_20)">
        <path
          d="M115.848 265.814L106.972 241.168C106.145 238.873 103.783 237.509 101.383 237.941L75.6001 242.577C71.4122 243.33 68.2575 238.841 70.385 235.156L113.008 161.33C114.389 158.939 117.447 158.119 119.838 159.5L142.757 172.732L165.675 185.964C168.067 187.345 168.886 190.403 167.506 192.794L124.882 266.62C122.755 270.305 117.29 269.817 115.848 265.814Z"
        ...
        <path
          ...
          fill="url(#paint1_linear_45_20)"
        />
        <g filter="url(#filter0_bd_45_20)">
          <path
          ...
          <path
            ...
            stroke="url(#paint3_linear_45_20)"
            shape-rendering="crispEdges"
          />
        </g>
        <g filter="url(#filter1_di_45_20)">
          <path
            d="M145.323 81.8294C147.279 78.6828 151.859 78.6828 153.815 81.8294L162.758 96.212C163.446 97.3191 164.539 98.1136 165.805 98.4261L182.247 102.486C185.844 103.375 187.259 107.73 184.871 110.563L173.956 123.512C173.116 124.509 172.698 125.795 172.792 127.095L174.011 143.987C174.278 147.683 170.573 150.374 167.141 148.979L151.452 142.599C150.245 142.108 148.893 142.108 147.685 142.599L131.997 148.979C128.565 150.374 124.86 147.683 125.127 143.987L126.346 127.095C126.44 125.795 126.022 124.509 125.182 123.512L114.266 110.563C111.878 107.73 113.294 103.375 116.891 102.486L133.333 98.4261C134.598 98.1136 135.692 97.3191 136.38 96.212L145.323 81.8294Z"
            fill="url(#paint4_linear_45_20)"
            shape-rendering="crispEdges"
          />
        </g>
      </g>
      <defs>
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_45_20"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_backgroundBlur_45_20"
            result="effect2_dropShadow_45_20"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_45_20"
            result="shape"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_45_20"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_45_20"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect2_innerShadow_45_20"
          />
        </filter>
        <linearGradient
