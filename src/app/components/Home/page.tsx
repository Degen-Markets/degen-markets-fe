  ...
  return (
    <div className="my-20 bg-gradient-to-t from-[#AB9FF1] to-[#202B38] pb-40">
      ...
      <div className="w-full px-3 max-w-7xl mx-auto ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full place-items-center place-content-center my-20">
            {displayedPools.map((pool, ind) => {
              ...
              return pool ? (
                ...
                <div
                  className="w-full h-60 bg-blue-light text-5xl text-cadet-blue-light cursor-default font-bold flex justify-center items-center bg-opacity-50 rounded-xl center-all"
                  key={ind}
                >
                  D
                </div>
        ...
        <div className="grid md:grid-cols-12 gap-10 lg:gap-24">
          <div className="md:col-span-7 ">
            <div>
              <div className="flex items-center space-x-2 ml-5">
                <CardHeading
                  icon={
                    <div className="w-7 h-7 md:w-10 md:h-10 relative -top-1 md:top-0">
                      <Image
          ...
          <div className="md:col-span-5 ">
            <div>
              <CardHeading showBordered={false} className="uppercase ml-5">
                Socials
              </CardHeading>
