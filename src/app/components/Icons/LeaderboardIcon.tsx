    ...
    >
      <g clipPath="url(#clip0_33_2)">
        <g filter="url(#filter0_f_33_2)">
          <path
            d="M70 40.5C70 40.2239 70.2239 40 70.5 40H229.5C229.776 40 230 40.2239 230 40.5V140C230 184.183 194.183 220 150 220C105.817 220 70 184.183 70 140V40.5Z"
        ...
        />
        <path
          d="M219.109 109.516C219.109 113.313 222.211 116.456 225.947 115.776C227.857 115.428 229.732 114.934 231.546 114.298C235.489 112.916 239.072 110.89 242.09 108.337C245.108 105.783 247.501 102.752 249.135 99.4151C250.768 96.0786 251.609 92.5026 251.609 88.8913C251.609 85.2799 250.768 81.704 249.135 78.3675C247.501 75.031 245.108 71.9995 242.09 69.4459C239.072 66.8922 235.489 64.8666 231.546 63.4846C229.732 62.8487 227.857 62.3548 225.947 62.0069C222.211 61.3266 219.109 64.4693 219.109 68.2663L219.109 68.8054C219.109 72.3046 222.025 75.0306 225.327 76.188C227.299 76.879 229.09 77.8918 230.599 79.1686C232.108 80.4454 233.305 81.9612 234.122 83.6294C234.938 85.2976 235.359 87.0856 235.359 88.8913C235.359 90.697 234.938 92.485 234.122 94.1532C233.305 95.8214 232.108 97.3372 230.599 98.614C229.09 99.8908 227.299 100.904 225.327 101.595C222.025 102.752 219.109 105.478 219.109 108.977L219.109 109.516Z"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="22"
            result="effect1_foregroundBlur_33_2"
          />
        </filter>
        <filter
          id="filter1_bd_33_2"
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_33_2"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_backgroundBlur_33_2"
            result="effect2_dropShadow_33_2"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_33_2"
            result="shape"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_33_2"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_33_2"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect2_innerShadow_33_2"
          />
        </filter>
        <linearGradient
