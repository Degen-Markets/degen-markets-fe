...
const ElectionIcon: FC<IconProps> = ({
  width = "184",
  height = "184",
  style,
}) => {
  return (
    ...
    >
      <g clipPath="url(#clip0_41_12)">
        <g filter="url(#filter0_f_41_12)">
          <path
            d="M255 139C255 152.807 243.807 164 230 164L70 164C56.1929 164 45 152.807 45 139L45 106.556C45 97.4407 49.9614 89.0477 57.9476 84.6532L137.948 40.632C145.452 36.5026 154.548 36.5026 162.052 40.632L242.052 84.6532C250.039 89.0477 255 97.4407 255 106.556L255 139Z"
            fill="url(#paint0_linear_41_12)"
          />
        </g>
        <g filter="url(#filter1_bd_41_12)">
          <rect
            x="133"
            y="140.593"
            width="35"
            height="100"
            rx="17.5"
            fill="url(#paint1_linear_41_12)"
          />
        </g>
        <g filter="url(#filter2_bd_41_12)">
          <rect
            x="188"
            y="140.593"
            width="35"
            height="100"
            rx="17.5"
            fill="url(#paint2_linear_41_12)"
          />
        </g>
        <g filter="url(#filter3_bd_41_12)">
          <rect
            x="78.0001"
            y="140.593"
            width="35"
        ...
        <g filter="url(#filter4_f_41_12)">
          <path
            d="M230 215.295C243.807 215.295 255 226.488 255 240.295C255 254.102 243.807 265.295 230 265.295L70 265.295C56.1929 265.295 45 254.102 45 240.295C45 226.488 56.1929 215.295 70 215.295L230 215.295Z"
            fill="url(#paint4_linear_41_12)"
          />
        </g>
        <g filter="url(#filter5_bd_41_12)">
          <rect
            x="250"
            y="220.295"
            width="40"
        ...
        <g filter="url(#filter6_bd_41_12)">
          ...
          <path
            ...
            stroke="url(#paint8_linear_41_12)"
            shapeRendering="crispEdges"
          />
        </g>
      </g>
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="22"
            result="effect1_foregroundBlur_41_12"
          />
        </filter>
        <filter
          id="filter1_bd_41_12"
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_41_12"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_backgroundBlur_41_12"
            result="effect2_dropShadow_41_12"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_41_12"
            result="shape"
          />
        </filter>
        <filter
